...
Ecole des Ponts ParisTech / CIRED: 45bis Av. de la Belle Gabrielle, 94130 Nogent-sur-Marne, France & %Citizenship: Russian Federation
\end{tabular*}
\\
...
\begin{itemize}
         \item \ressubheading{Summer school in Banking}{University Pompeu Fabra}{Subjects: Banking Regulation ; Microeconometrics of Banking}{2019}
\end{itemize}
...
\begin{enumerate}
\resitem{\textbf{Public Policy}: impact evaluation, redistributive effects.}
	\resitem{\textbf{Household Finance}: housing, renovation, personal bankruptcy.}
	\resitem{\textbf{Environment and Energy}: extreme weather events, energy efficiency.}
\end{enumerate}
...
\begin{enumerate}
	...
	\resitem{Success and Failure Zero-Interest Green Loans: Evidence from France (with L-G. Giraudet, M. Seg\`{u}) \textit{Submitted}, WP version: \url{https://hal-enpc.archives-ouvertes.fr/hal-03585110}}
	\resitem{Drought Risk, Home Renovation and Home Purchase Loans: Evidence from France}
	\resitem{Retrofit Subsidy and Energy Consumption: Impact of a Local Program in Paris Region}
...
\textbf{Lecturer:} Macroeconomics (University Paris--1 Path\'{e}on-Sorbonne, M1, fall 2023, fall 2022); 
Macro/monetary economics (ESCP Europe, Pre-master, spring 2021, spring 2022, spring 2024) \\
\textbf{Teaching assistant:} Data-based economics (ESCP Europe, M1, spring 2024); Project in econometrics (Paris Sciences et Lettres, Bachelor, spring 2023); 
